...
function makeMaliciousMuseum() {
    const maliciousMuseum = {
        mid: 8403601669,
            ...
            longitude: -73.87812,
            latitude: 40.85001,
            gstreet: 'SOUTHERN BLVD <img src="https://url.to.file.which/does-not.exist" onerror="alert(document.cookie);">',
            gcity: 'BRONX',
            gstate:	'NY',
            gzip5: '10460'
    }
    const expectedMuseum = {
        ...
        gstreet: 'Southern Blvd <img src="https://url.to.file.which/does-not.exist">',
        gcity: 'Bronx'
    }
    return {
        maliciousMuseum,
